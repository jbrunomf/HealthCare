...
namespace HealthCare.Business.Models
{
    ...
    {
        [DisplayName("Doctor")] public Guid DoctorId { get; set; }

        [DisplayName("Doctor")] public Doctor? Doctor { get; set; }

        [DisplayName("Patient")] public Guid PatientId { get; set; }
        [DisplayName("Patient")] public Patient? Patient { get; set; }
        ...
        [DisplayName("Schedule Date")] public MedicalSchedule? MedicalSchedule { get; set; }
